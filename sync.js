...
(function () {
    ...
    var CODE_LENGTH = 6;
    var STORE_COLLECTIONS = ['photos', 'memories', 'moments', 'milestones'];
    ...
    var Sync = {
        ...
        _imageCache: {},
        _signedUrls: {},
        _storeCache: { photos: {}, memories: {}, moments: {}, milestones: {} },
        _coupleRow: null,
        _membersRows: [],
        _channel: null,
        _delChannel: null,
    ...
    Sync.detach = function () {
        ...
        this._channelStatus = null;
        this._storeCache = { photos: {}, memories: {}, moments: {}, milestones: {} };
